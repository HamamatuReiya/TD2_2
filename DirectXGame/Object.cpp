...
void Object::Initialize(
	...
	worldTransform_[1].translation_ = {-2.0f, 0.0f, 42.0f};
	worldTransform_[2].translation_ = {4.0f, 0.0f, 76.0f};
	worldTransform_[3].translation_ = {40.0f, 0.0f, 80.0f};
	worldTransform_[4].translation_ = {30.0f, 0.0f, 40.0f};
	worldTransform_[5].translation_ = {72.0f, 0.0f, -8.0f};
	worldTransform_[6].translation_ = {60.0f, 0.0f, 40.0f};
}
