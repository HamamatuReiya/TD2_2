...
void Table::Initialize(
	...
	worldTransform_[0].translation_ = {-1.0f, 0.0f, -1.0f};
	worldTransform_[1].translation_ = {-1.0f, 0.0f, 0.0f};
	worldTransform_[2].translation_ = {-1.0f, 0.0f, 1.0f};
	worldTransform_[3].translation_ = {0.0f, 0.0f, -1.0f};
	worldTransform_[4].translation_ = {0.0f, 0.0f, 0.0f};
	worldTransform_[5].translation_ = {0.0f, 0.0f, 1.0f};
	worldTransform_[6].translation_ = {1.0f, 0.0f, -1.0f};
	worldTransform_[7].translation_ = {1.0f, 0.0f, 0.0f};
	worldTransform_[8].translation_ = {1.0f, 0.0f, 1.0f};
}
